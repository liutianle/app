...
public class VideoSectionAddAdapter extends BaseSectionQuickAdapter<MySection, BaseViewHolder> {
    /**
     ...
     */
    public VideoSectionAddAdapter(int layoutResId, int sectionHeadResId, List<MySection> data) {
...
//        helper.setImageResource(R.id.movie_cover, video.getImg());
        ...
        helper.setText(R.id.number, video.getNumber()+"1");
    }
